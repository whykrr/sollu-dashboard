<template>
    <div class="flex h-screen">
        ...
        <main class="flex flex-col w-full gap-4">
            ...
            <div class="flex-1 overflow-y-auto floating-scrollbar p-4 pt-0">
                <!-- Stats Section -->
                <div
                    class="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-4 gap-2 mb-4"
                >
                    <Widget
                ...
                <div class="flex flex-col gap-4 mb-4">
                    <Container title="Data List">
                                ...
                                <div class="flex flex-row gap-3 justify-end">
                                    <div class="text-sm">
                                        ...
                                        <select
                                            name=""
                                            id=""
                                            class="input sm:text-sm text-dark dark:text-light border-r-[0.5px] rounded-r-none"
                                        >
                                            <option>Name</option>
                                            <option>Class</option>
                                        ...
                                        <select
                                            name=""
                                            id=""
                                            class="input sm:text-sm text-dark dark:text-light border-l-[0.5px] rounded-l-none"
                                        >
                                            <option>Asc</option>
                                            <option>Desc</option>
                                        </select>
                                    ...
                                    <div class="text-sm">
                                        ...
                                        <select
                                            name=""
                                            id=""
                                            class="input sm:text-sm text-dark dark:text-light"
                                        >
                        ...
                        <div class="flex flex-row gap-4 justify-end">
                            <DataViewSwitcher @is-list="updateView" />
                        </div>
